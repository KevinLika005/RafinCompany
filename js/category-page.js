document.addEventListener('DOMContentLoaded', () => {
  ...
  function renderMissingState(titleText, descriptionText) {
    ...
    if (window.SeoHead && typeof window.SeoHead.applyRouteMeta === 'function') {
      window.SeoHead.applyRouteMeta({
        pageType: 'category',
        titleOverride: `${titleText} | Rafin Company`,
  ...
  const cardsHtml = projects.map((project) => {
    ...
    const slugUrl = project.slug
      ? buildUrl(`project.html?slug=${encodeURIComponent(project.slug)}&lang=en`)
      : '#';
      ...
      <div class="col-sm-6 col-lg-4 project-card-item">
        <article class="project-card">
          ...
          <div class="project-card__content">
            ...
            <h3 class="project-card__title heading-5"><a href="${slugUrl}">${escapeHtml(projectTitle)}</a></h3>
