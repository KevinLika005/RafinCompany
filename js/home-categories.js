document.addEventListener('DOMContentLoaded', () => {
  ...
  function getCategoryUrl(category) {
    return category.slug
      ? buildUrl(`category.html?slug=${encodeURIComponent(category.slug)}&lang=en`)
      : buildUrl('projects.html?lang=en');
  }
      ...
      <article class="home-projects-showcase__panel-card">
        <div class="home-projects-showcase__content">
          ...
          <div class="home-projects-showcase__actions">
            ...
            <a class="home-projects-showcase__cta home-projects-showcase__cta--secondary" href="${escapeHtml(buildUrl('projects.html?lang=en'))}">
        ...
        <div class="home-projects-showcase__media">
          <figure class="home-projects-showcase__image-frame">
            <img src="${escapeHtml(image)}" alt="${escapeHtml(`${imageAltPrefix} ${title}`)}" width="1200" height="900" loading="lazy" decoding="async" fetchpriority="low">
          </figure>
        </div>
      </article>
    `;
    window.I18n.localizeInternalLinks(panelBody);
  }
